...
from dataline.api.llm_connections import router as llm_connections_router
...
class App(fastapi.FastAPI):
    def __init__(  # type: ignore[misc]
        ...
        self.include_router(llm_connections_router, prefix="/api/llm-connections", tags=["llm_connections"], dependencies=common_dependencies)
